...
def on_reset_button():
    ...
    mqtt_manager.publish_on_topic(topic_system,"Reset del dispositivo in corso")
    step_motor.return_to_home()
    led.off()
    machine.reset()
...
def callback_function(topic, msg):
    ...
    if topic == topic_sub :
        ...
        DeliveryManager.deliveryFunction(ir,mqtt_manager,step_motor,display,anemone,topic_pub,pillTimeout)
